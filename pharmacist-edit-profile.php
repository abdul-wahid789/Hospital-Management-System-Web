    ...
    <div class="contianer">
        ...
        <div class="container_2">
            <aside>
                ...
                <ul class="menu">
                <li ><a href="pharmacist-dashboard.php"><i class="fa-solid fa-table-columns"></i>Dashboard</a></li>
                    <li class="active_menu"><a href="pharmacist-edit-profile.php"><i class="fa-solid fa-wrench"></i>Profile Settings</a></li>
