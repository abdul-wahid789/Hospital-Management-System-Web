...
<body>
    <div class="container">
        ...
        <div class="right">
            <form action="user-add-doctor.php" method="POST" enctype="multipart/form-data">
                <div class="container_information" id="container_information_1">
                    ...
                    <input type="button" value="Continue" onclick="container2_visible()">
                </div>
                ...
                <div class="container_information" id="container_information_2">
                    ...
                    <div class="row_wise_input">
                        ...
                        <input type="button" class="continue_btn" value="Continue" onclick="container3_visible()">
                    </div>
                </div>
                ...
                <div class="container_information" id="container_information_3">
                    ...
                    <div class="image_change">
                        ...
                        <input type="file" class="change_photo_btn" name="image" id="" accept=".png,.jpg,.jpeg">
                    ...
                    <input type="hidden" value="doctor" name="table_name" hidden>
                    <div class="row_wise_input">
                        <input type="button" value="Back" onclick="container2_visible()">
    ...
    <script src="doctor-registration.js"></script>
</body>
