...
<body>
    <div class="container">
        <div class="left">
            ...
            <i class="fa-solid fa-prescription-bottle-medical fa-registration" style="  font-size: 5em;
            margin-top: 25vh;
            ...
            <form action="user-add.php" method="POST" enctype="multipart/form-data">
                ...
                <div class="container_information" id="container_information_2">
                    ...
                    <div class="image_change">
                        ...
                        <input type="file" class="change_photo_btn" name="image" id=""
                            accept="image/png, image/jpg, imgage/jpeg" required>
                    ...
                    <input type="hidden" value="pharmacist" name="table_name" hidden>
                    <div class="row_wise_input">
