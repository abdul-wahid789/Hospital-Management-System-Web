        ...
        <div class="container_2">
            <aside>
                ...
                <li><a href="patient-dashboard.php"><i class="fa-solid fa-table-columns"></i>Dashboard</a></li>
                    ...
                    <li class="active_menu"><a href="patient-prescription.php"><i class="fa-solid fa-prescription-bottle"></i>Prescription</a></li>
                ...
                <div class="appointments_container">
                    ...
                    <table>
                        ...
                        <tr>
                            ...
                            <td>
                                <a href="patient-prescription-details.php"><button class="view_pres">View</button></a>
                            </td>
