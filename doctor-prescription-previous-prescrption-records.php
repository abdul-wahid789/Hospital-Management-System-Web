...
<head>
    ...
    <link rel="stylesheet" href="doctor-prescription-previous-prescrption-records.css">
</head>
            ...
            <div class="dashboard_items">
                <div class="appointments_container doctor-medical-records">
                    <div class="heading">
                        ...
                        <h1>Prescrption Records of Abdul Wahid</h1>
                    </div>
                    <table>
                        <tr>
                            <th>Doctor</th>
                        ...
                        <tr>
                            ...
                            <td>
                                <button class="view_pres">View</button>
                            </td>
