function container2_visible() {
    ...
    div_3 = document.getElementById("container_information_3").style.display = "none";
...
function container3_visible() {
    div_1 = document.getElementById("container_information_1").style.display = "none";
    div_2 = document.getElementById("container_information_2").style.display = "none";
    div_3 = document.getElementById("container_information_3").style.display = "block";
