...
<head>
    ...
    <link rel="stylesheet" href="patient-medical-record.css">
</head>
    ...
    <div class="contianer">
        <div class="header">
            ...
            <div class="logout">
                ...
                <a href="logout.php"><h3> <i class="fa-solid fa-right-from-bracket"></i>Logout</h3></a>
            </div>
        </div>
        <div class="container_2">
            <aside>
                ...
                <li><a href="patient-dashboard.php"><i class="fa-solid fa-table-columns"></i>Dashboard</a></li>
                    ...
                    <li class="active_menu"><a href="patient-medical-record.php"><i class="fa-regular fa-clipboard"></i>Medical Records</a></li>
