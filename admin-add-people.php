        ...
        <div class="container_2">
            <aside>
                ...
                <li><a href="admin-dashboard.php"><i class="fa-solid fa-table-columns"></i>Dashboard</a></li>
                    <li><a href="admin-add-people.php" class="active_menu"><i class="fa-solid fa-plus"></i>Add People</a></li>
            ...
            <div class="dashboard_items">
                ...
                <div class="health_information">
                    <div class="information">
                        ...
                        <div class="information_container" onclick="show_department()">
                            <img src="https://img.icons8.com/office/48/null/department.png" />
                            <h2>Add Department</h2>
                        </div>
                        <div class="information_container" onclick="show_admin()">
                            <img src="https://img.icons8.com/office/48/null/administrator-male--v1.png"/>
                            <h2>Add Admin</h2>
                        </div>
                    </div>
                </div>
                <div class="appointments_container">
                    ...
                    <div id="add_department">
                        <div class="container_information">
                            ...
                            <div class="image_change">
                                <img src="images/pic/my_pic.jpg" alt="" id="image_preview_department">
                                <input type="file" class="change_photo_btn change_photo_btn_department" name="" id=""
                                    accept=".png,.jpg,.jpeg" >

                            </div>
                            <label for="department_name">Department Name</label>
                            <input type="text" name="department_name" id="" required placeholder="">
                            <label for="department_fee">Department Doctor Fee</label>
                            <input type="number" name="department_fee" id="" required placeholder="Enter Amount">
                            <div class="row_wise_input">
                                <input type="submit" value="Register" onclick="">
                            </div>
                        </div>
                    ...
                    <div id="add_admin">
                        <div class="right">
                            ...
                            <div class="container_information" id="container_information_2">
                                ...
                                <h1>Personal Details<span style="color: red;">*</span></h1>
                                <div class="image_change">
                                    <img src="images/pic/my_pic.jpg" alt="" id="image_preview_admin">
                                    <input type="file" class="change_photo_btn change_photo_btn_admin" name="" id=""
                                        accept=".png,.jpg,.jpeg">
